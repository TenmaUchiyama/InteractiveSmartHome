...
namespace SpatialLLM.Network
{
    ...
    [Serializable]
    public class LLMQueryRequestType
    {

        public string llm_message;
        public string task_id;
        public string attempt_id;


        public string SerializedData => JsonConvert.SerializeObject(this);
    ...
    [Serializable]
    public class PointingLLMQueryRequestType : LLMQueryRequestType
    {
        public List<DeviceLabelData> pointed_devices;
    }


    [Serializable]
    public class PointingSpatialLLMQueryRequestType : LLMQueryRequestType
    {
        public List<NetworkDataType.DeviceSpatialData> pointed_devices;
    }
