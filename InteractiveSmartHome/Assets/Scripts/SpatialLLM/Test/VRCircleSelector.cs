...
public class VRCircleSelector : MonoBehaviour
{
    ...
    private List<SADevice> allDevices = new List<SADevice>();
   ...
   void ScreenSpaceSelect()
{
    ...
    foreach (var go in this.allDevices)
    {
        ...
        // 5. 選択されたオブジェクトを色付け
        go.gameObject.GetComponent<DrawOnHover>().VisualizeTargetDevice(new Color(255,0,0)); 
