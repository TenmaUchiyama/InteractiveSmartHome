...
from agents.label_agent.label_node import label_agent


from agents.label_agent.label_node import label_agent_node
from sr_app_types.no_tool_agent_types import LabelState

# テスト用のユーザープロンプト
test_state = LabelState(user_prompt="シェルフライト1－10の電気を点けてください。")

# 正しい呼び出し
result = label_agent_node(test_state)
